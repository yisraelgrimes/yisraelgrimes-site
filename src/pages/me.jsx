...
export default function MePage({ data }) {
	...
	return (
		<Layout title="About Me">
			...
			<Img
				image={data.family}
				alt="Me and my family sitting in the woods with Christmas trees in the background"
				caption="I'm not mad here, I just never learned how to properly smile for pictures."
			/>
...
export const query = graphql`
	query {
		...
		family: file(relativePath: { eq: "grimes-family.jpg" }) {
			childImageSharp {
				fluid(maxWidth: 800) {
					...GatsbyImageSharpFluid
					...GatsbyImageSharpFluidLimitPresentationSize
